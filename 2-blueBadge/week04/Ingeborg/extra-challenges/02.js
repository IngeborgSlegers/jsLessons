/*
    BRONZE :    
        Create a function that takes in an array and returns the sum of all the element of an array.

    SILVER :
        If the array does not have any elements in it, return a string message for invalid arguments.
